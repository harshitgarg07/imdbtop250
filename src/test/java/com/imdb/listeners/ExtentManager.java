...
public class ExtentManager {
    ...
    private static String reportFileName = "Automaton-Report.html";
    private static String macPath = System.getProperty("user.dir")+ "/target";
    private static String windowsPath = System.getProperty("user.dir")+ "\\target";
